// const taskCardView = (target) => {
//   const $taskCardTarget = document.querySelector(target);

//   const template = `
//                 <section class="todo-task" data-viewmodel="taskCard">
...
//   $taskCardTarget.insertAdjacentHTML('afterbegin', template);
// };

// export default taskCardView;

{
  /* <section class="todo-task active-bg" data-viewmodel="newTaskpCard">
  <form data-type="input-task">
    <div class="task-title">
      <textarea
